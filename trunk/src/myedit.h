...
/**
*  Widget servant à écrire une commande dans le débogueur.
...
class MyEdit : public QLineEdit
{
	...
	public:
	/**Constructeur, initialise un lineedit à vide
	*/
	...
	*/
	~MyEdit();
	/**Fonction gérant l'évènement "keyEvent"*/
	void keyPressEvent ( QKeyEvent * event );

	public slots:
	/**Fonction permettant de garder en mémoire les dernières commandes entrées par l'utilisateur */
	void enter(QString);
